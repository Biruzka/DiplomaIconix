...
/* component */
import PrototypeUpdatePageComponent from './prototype-update-page.component.js';

const module = angular
    .module('app.components.prototypeUpdatePage', [

    ]);

module
    .component('iconixPrototypeUpdatePage', PrototypeUpdatePageComponent)
